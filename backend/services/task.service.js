...
export const createTaskService = async (workspaceId, projectId, userId, body) => {
  ...
  if (assignedTo) {
    ...
    if (!isAssignedUserMember) {
      ...
      console.log("Assigned user is not a member of this workspace.");
    }
  }
...
export const updateTaskService = async (workspaceId, projectId, taskId, body) => {
  ...
  if (!task || task.project.toString() !== projectId.toString()) {
    ...
    console.log("Task not found or does not belong to this project");
  }
...
export const deleteTaskService = async (workspaceId, taskId) => {
  ...
  if (!task) {
    ...
    console.log("Task not found or does not belong to the specified workspace");
  }
